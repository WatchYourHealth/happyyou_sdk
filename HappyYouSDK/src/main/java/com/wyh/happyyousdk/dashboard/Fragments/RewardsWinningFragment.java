...
import com.wyh.happyyousdk.databinding.WinningFragmentLayoutBinding;
...
public class RewardsWinningFragment extends Fragment implements ScratchListener {

    Context context;
    WinningFragmentLayoutBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater,R.layout.winning_fragment_layout,container,false);
        context = getActivity();
        ...
        binding.includeToolbar.llBack.setVisibility(View.GONE);
...
//        checkPermission(Manifest.permission.CAMERA, CAMERA_PERMISSION_CODE, false);
        ...
        binding.slidingTabs.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                tab.getIcon().setTint(getResources().getColor(R.color.blue_cyan, context.getTheme()));
            }

            @RequiresApi(api = Build.VERSION_CODES.M)
            @Override
            public void onTabUnselected(TabLayout.Tab tab) {
                tab.getIcon().setTint(getResources().getColor(R.color.happy_dark_grey, context.getTheme()));
            }
    ...
    private void showPopup(View v) {
        ...
        popup.setOnMenuItemClickListener(menuItem -> {
            ...
            if (itemId == R.id.menu_history) {
                ...
                Intent intent2 = new Intent(context, AddDiaryActivity.class);
                ...
                startActivity(new Intent(context, BadgesActivity.class));
            }
            return false;
        });
    }
    private void setupViewPager(ViewPager viewPager) {
        SampleFragmentPagerAdapter adapter = new SampleFragmentPagerAdapter(getActivity().getSupportFragmentManager());
