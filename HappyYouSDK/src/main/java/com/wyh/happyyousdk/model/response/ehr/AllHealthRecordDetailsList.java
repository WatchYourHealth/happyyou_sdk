...
public class AllHealthRecordDetailsList {
    ...
    public AllHealthRecordDetailsList() {
    }

    public AllHealthRecordDetailsList(String msg, Boolean success, List<Datum> data) {
        super();
        this.msg = msg;
    ...
    public static class Datum {
        ...
        @Expose
        private List<HealthRecordFiles> healthRecordFilesList = null;

        public Datum(Integer id, String uuid, Integer healthRecordTypeID, String reportDate, String path, Object name, Object mobile, Object address, String remarks, String testName, String createdBy, String isActive, Object tags, String healthRecordTypeName, List<HealthRecordFiles> healthRecordFilesList) {
            super();
            this.id = id;
            this.uuid = uuid;
        ...
        public List<HealthRecordFiles> getHealthRecordFilesList() {
            return healthRecordFilesList;
        }

        public void setHealthRecordFilesList(List<HealthRecordFiles> healthRecordFilesList) {
            this.healthRecordFilesList = healthRecordFilesList;
        }

        public static class HealthRecordFiles {
