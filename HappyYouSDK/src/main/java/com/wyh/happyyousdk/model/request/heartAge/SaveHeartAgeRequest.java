...
public class SaveHeartAgeRequest {
    ...
    public SaveHeartAgeRequest(String integrationid, String conversationId, String surveyVersion, String status, String answerJson, String createdDate, String modifiedDate, Boolean isAssessmentCompleted) {
