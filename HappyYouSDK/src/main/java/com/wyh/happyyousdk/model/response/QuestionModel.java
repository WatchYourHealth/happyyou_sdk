...
public class QuestionModel {
    ...
    public ArrayList<String> getKeywords() {
        ...
        if (keywords != null && keywords.contains(",")) {
            ArrayList<String> arrString = new ArrayList<>(Arrays.asList(keywords.split(",")));
            return arrString;
        } else {
    ...
    public QuestionModel(Integer questionId, String question, List<String> options, String answer, Object userAns, String image, String explanation) {
