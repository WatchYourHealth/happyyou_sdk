...
public class QuizathonScoreActivity extends AppCompatActivity implements ScratchListener, rewardDialogCloseListener, ReTakeQuizListener,
        onRewardClick, spinRewardCallBack {
    ActivityQuizathonScoreBinding binding;
    Context context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_quizathon_score);
        context = this;
...
//                if(quizathonModel != null && quizathonModel.getMessageNote() != null && !quizathonModel.getMessageNote().isEmpty()){
//                    binding.tvMessageNote.setVisibility(View.VISIBLE);
//                    binding.tvMessageNote.setText(quizathonModel.getMessageNote());
//                }else{
//                    binding.tvMessageNote.setVisibility(View.GONE);
//                }
            } catch (Exception ex) {
            ...
            try {
                ...
                if(dialogModel == null && quizathonModel != null && quizathonModel.getDialog_model() != null){
                    dialogModel =quizathonModel.getDialog_model();
                }
            } catch (Exception ex) {
                dialogModel = null;
                if(quizathonModel != null && quizathonModel.getDialog_model() != null){
                    dialogModel =quizathonModel.getDialog_model();
                }
            }
        ...
        if (quizathonModel != null && quizathonModel.getShowConsent() != null && quizathonModel.getShowConsent()) {
    ...
    public void showBottomSheet() {
        if (saveQuizathonAnsModel != null) {
            ...
            if (quizathonModel != null && quizathonModel.getRedirectionKey() != null
                ...
                MessageInfoDialog messageInfoDialog = new MessageInfoDialog(QuizathonScoreActivity.this, ContextCompat.getDrawable(context, R.drawable.ic_hu_info_red), "Information", "You have already uploaded an image. You will receive your rewards once it is approved");
                messageInfoDialog.show();
                //Toast.makeText(context, "You have already uploaded an image. You will receive your rewards once it is approved", Toast.LENGTH_LONG).show();
                return;
            }
            RewardInfoBottomSheet dialog = new RewardInfoBottomSheet(context, reward, "", new onRewardDialogClick() {
                ...
                public void onStartClick() {
                    ...
                    if (reward.getRedirectionKey().contains("feedback")) {
                        ...
                        instance.showPopUpFeedbackCallback(QuizathonScoreActivity.this, feedbackResponseData, QuizathonScoreActivity.this);
                    }
                }
                ...
                public void onCompleteClick() {
                    if (reward.getRedirectionKey().contains("feedback")) {
                        ...
                        waterIntakeDialoge(QuizathonScoreActivity.this, NewDashboardHelper.Companion.getWaterIntakeGoal(), NewDashboardHelper.Companion.getWaterIntake(), NewDashboardHelper.Companion.getWaterIntakeAllowed());
                    } else if (reward.getRedirectionKey().equalsIgnoreCase("meditation")) {
                        showPopUpZenZone(QuizathonScoreActivity.this, Double.parseDouble(NewDashboardHelper.Companion.getCurrentValueZenZone()));
                    } else {
                        if (reward.getRedirectionKey().equalsIgnoreCase("quiz") || reward.getRedirectionKey().equalsIgnoreCase("trivia")) {
                            getQuestionData(reward.getRedirectionKey());
                        } else {
            ...
            if(quizathonModel.getMessageNote() != null && !quizathonModel.getMessageNote().isEmpty()){
                dialog.setMessageNote(quizathonModel.getMessageNote());
            }
    ...
    public void checkPermission(String permission, int requestCode) {
        ...
        if (ContextCompat.checkSelfPermission(QuizathonScoreActivity.this, permission) == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(QuizathonScoreActivity.this, new String[]{permission}, requestCode);
        } else {
            openGalleryOnly();
        }
    }
    ...
    private void showBonusRewardsPopup(String rewards, Context context) {
        ...
        binding.scratchView.setScratchListener(QuizathonScoreActivity.this);
    ...
    private void showBonusStampPopup(String rewards, Context context) {
        ...
        Rect displayRectangle = new Rect();
        Window window = ((QuizathonScoreActivity) context).getWindow();
                ...
                public void onResponse(Call<GetQuizathonDetailsResponse> call, Response<GetQuizathonDetailsResponse> response) {
                    ...
                    if (response.code() == 200 && response.isSuccessful() && response.body() != null) {
                        ...
                        if (quizathonModel.getAnswerJson() != null && !quizathonModel.getAnswerJson().isEmpty() && quizathonModel.isQuizCompleted()) {
                            ...
                            RegistrationDialog dialog = new RegistrationDialog(QuizathonScoreActivity.this, quizathonModel.getRegistrationQuestions(), quizathonModel.getRegTitle(), quizathonModel.getQuizId(), intent, quizathonModel.getQuizStarted(), quizathonModel.getQuizDesc());
                            ...
                            QuizMessageDialog dialog = new QuizMessageDialog(QuizathonScoreActivity.this, quizathonModel.getDialog_model(), apiInterfaceWyh);
                            dialog.show();
                        } else {
                            Intent intent = new Intent(context, QuizathonActivity.class);
    ...
    public void getRetakeQuestion(String qid) {
        ...
        call.enqueue(new Callback<RetakeResponseModel>() {
                ...
                if (response.body() != null && response.code() == 200) {
                    if (response.body().getDatamodel() != null && response.body().getDatamodel().getQuestionJson() != null) {
                        if (response.body().getDatamodel().getMessage() != null) {
                            ...
                            QuizMessageDialog dialog = new QuizMessageDialog(QuizathonScoreActivity.this, modelDialog, apiInterfaceWyh);
                            dialog.show();
                        } else {
                        ...
                        Toast.makeText(QuizathonScoreActivity.this, response.body().getDatamodel().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            public void onFailure(Call<RetakeResponseModel> call, Throwable t) {
                if (progressDialog != null && progressDialog.isShowing())
                    progressDialog.dismiss();
                Toast.makeText(QuizathonScoreActivity.this, getResources().getString(R.string.error_string), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void SaveQuizRegistration(
        ...
        call.enqueue(new Callback<SaveQuizRegistrationResponse>() {
                ...
                if (response.code() == 200 && response.body() != null) {
                    ...
                    try {
                        if (isQuizStarted) {
                            ...
                            QuizMessageDialog dialog = new QuizMessageDialog(QuizathonScoreActivity.this,
            ...
            public void onFailure(Call<SaveQuizRegistrationResponse> call, Throwable t) {
                CommonUtils.dismissDialoge();
                Toast.makeText(QuizathonScoreActivity.this, "Something went wrong! Please try again later.", Toast.LENGTH_SHORT).show();
            }
        });
    }
                    ...
                    try {
                        runOnUiThread(new Runnable() {
                            public void run() {
                                fileDataList.clear();
                                deleteImageFile();
                                MessageInfoDialog messageInfoDialog = new MessageInfoDialog(QuizathonScoreActivity.this, ContextCompat.getDrawable(context, R.drawable.ic_hu_info_red), "Information", "You have uploaded an image. You will receive your rewards once it is approved");
                                messageInfoDialog.show();
                            }
                        });
                    } catch (Exception e) {
                        Toast.makeText(context, "Unable to process request. Please try again later", Toast.LENGTH_SHORT).show();
                    }
        ...
        if (showNextGameButton) {
            if (nextGameRedirectTo != null && !nextGameRedirectTo.isEmpty()) {
                if (nextGameRedirectTo.contains("_")) {
                    ...
                    Intent intent = new Intent(QuizathonScoreActivity.this, PlayAndWinActivity.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                } else if (nextGameRedirectTo.equalsIgnoreCase("quizathon")) {
                    Intent intent = new Intent(QuizathonScoreActivity.this, QuizathonViewAllActivity.class);
            ...
            if (isRetakeAvailable) {
                if (quizathonModel.getShowConsent() != null && quizathonModel.getShowConsent()) {
                    ...
                    RetakeAlertDialog retakeAlertDialog = new RetakeAlertDialog(QuizathonScoreActivity.this, retakePointstoBurn, ContextCompat.getDrawable(QuizathonScoreActivity.this, R.drawable.ic_banner_quiz), title, message, (position, name) -> {
            ...
            public void onResponse(Call<GetQuizResponseModel> call, Response<GetQuizResponseModel> response) {
                ...
                if (response.body() != null && response.code() == 200) {
                    ...
                    if (response.body().getData().getQuestions() != null) {
                        ...
                        boolean isAssigned = getQuizResponseModel.getData().isAssigned();
                        String qId = "" + response.body().getData().getQid();
                        ...
                        if (getQuizQuestions != null && getQuizQuestions.size() == 1) {
                            GetQuizQuestions quizCategory = getQuizQuestions.get(0);
                            if (quizCategory.getCategoryName().equalsIgnoreCase("Trivia") && !isAssigned) {
                                getTriviaData();
                            } else {
                                Intent intent = new Intent(QuizathonScoreActivity.this, QuizActivity.class);
                        ...
                        } else if (getQuizQuestions != null && getQuizQuestions.size() > 0) {
                            RedirectionModel redirectionModel = new RedirectionModel(type, false, "", "", "", "", "", "", 0, "", "", "", "", "");
                            RedirectionMethod.INSTANCE.redirectionScreen(redirectionModel, context);
                        }


                    } else {
                        Toast.makeText(QuizathonScoreActivity.this, response.body().getMsg(), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Analytics.logEvent(QuizathonScoreActivity.this, getClass().getName(), getString(R.string.quiz_get_questions_failed));
                    Toast.makeText(QuizathonScoreActivity.this, getResources().getString(R.string.error_string), Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onResponse(@NonNull Call<TriviaHistoryResponse> call, @NonNull Response<TriviaHistoryResponse> response) {
                ...
                if (response.body() != null && response.code() == 200) {
                    if (response.body().getData() != null && response.body().getData().size() > 0) {
                        ...
                        Intent intent = new Intent(QuizathonScoreActivity.this, QuizathonScoreActivity.class);
                        ...
                        startActivity(new Intent(QuizathonScoreActivity.this, QuizHistoryActivity.class));
                    }
                }
            }
