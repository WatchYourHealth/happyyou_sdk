...
public class QuizathonGridCardsAdapterNew extends RecyclerView.Adapter<QuizathonGridCardsAdapterNew.GridCardsViewHolder> {
    ...
    public QuizathonGridCardsAdapterNew(List<RewardItem> rewardItemList, String type, onRewardClick onRewardClick) {
    ...
    @NonNull
    @Override
    public QuizathonGridCardsAdapterNew.GridCardsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new QuizathonGridCardsAdapterNew.GridCardsViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull QuizathonGridCardsAdapterNew.GridCardsViewHolder holder, int position) {
        QuizRewardViewAdapter adapter = new QuizRewardViewAdapter(getSubList(position), mContext, type, new onRewardClick() {
            @Override
