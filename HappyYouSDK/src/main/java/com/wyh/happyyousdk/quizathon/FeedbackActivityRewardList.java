...
import com.wyh.happyyousdk.quizathon.adapter.QuizathonGridCardsAdapter;
...
public class FeedbackActivityRewardList extends AppCompatActivity implements ScratchListener, onRewardClick, spinRewardCallBack, rewardDialogCloseListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.tvTitle.setText("Feedback Activity");
...
//         rewardResponse = new Gson().fromJson(response, postLogRewardType);
        ...
        if (rewardResponse.getData().getActiveList() != null && !rewardResponse.getData().getActiveList().isEmpty()) {
            isDataFound = true;
            int maxLength = rewardResponse.getData().getActiveList().size();
            if (maxLength > 9) {
                maxLength = 9;
            }
            ...
            QuizathonGridCardsAdapter gridCardsAdapter = new QuizathonGridCardsAdapter(rewardResponse.getData().getActiveList().subList(0, maxLength), "Active", this);
            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(FeedbackActivityRewardList.this, LinearLayoutManager.HORIZONTAL, false);
            ...
            LinearLayoutManager absorbHealthTvLinearLayoutManager1 = new LinearLayoutManager(FeedbackActivityRewardList.this);
            ...
            IndicatorsAdapter absorbHealthTvIndicatorsAdapter = new IndicatorsAdapter(FeedbackActivityRewardList.this, indicatorSize, 0);
            ...
            binding.tvActiveVewAll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent in = new Intent(FeedbackActivityRewardList.this, QuizathonViewAllActivity.class);
                    in.putExtra("type", "RewardActive");
        ...
        if (rewardResponse.getData().getCompletedList() != null && !rewardResponse.getData().getCompletedList().isEmpty()) {
            isDataFound = true;
            int maxLength = rewardResponse.getData().getCompletedList().size();
            if (maxLength > 9) {
                maxLength = 9;
            }
            ...
            QuizathonGridCardsAdapter gridCardsAdapter = new QuizathonGridCardsAdapter(rewardResponse.getData().getCompletedList().subList(0, maxLength), "Redeemed", this);
            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(FeedbackActivityRewardList.this, LinearLayoutManager.HORIZONTAL, false);
            ...
            binding.tvCompletedVewAll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    APILogs.INSTANCE.activityTracker("A_PlayAndWinDashboard_PlayNLearn_ViewAll_Clicked", context);
                    Intent in = new Intent(FeedbackActivityRewardList.this, QuizathonViewAllActivity.class);
                    in.putExtra("type", "RewardRedeemed");
        ...
        if (rewardResponse.getData().getExpiredList() != null && !rewardResponse.getData().getExpiredList().isEmpty()) {
            ...
            binding.tvExpiredVewAll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent in = new Intent(FeedbackActivityRewardList.this, QuizathonViewAllActivity.class);
                    in.putExtra("type", "RewardExpired");
            ...
            RewardInfoBottomSheet dialog = new RewardInfoBottomSheet(context, reward, type, new onRewardDialogClick() {
                ...
                public void onStartClick() {
                    ...
                    if (reward.getRedirectionKey().contains("feedback")) {
                        ...
                        instance.showPopUpFeedbackCallback(FeedbackActivityRewardList.this, feedbackResponseData, FeedbackActivityRewardList.this);
                    }
                }
                ...
                public void onCompleteClick() {
                    ...
                    if (reward.getRedirectionKey().contains("feedback")) {
                        ...
                        waterIntakeDialoge(FeedbackActivityRewardList.this, NewDashboardHelper.Companion.getWaterIntakeGoal(), NewDashboardHelper.Companion.getWaterIntake(), NewDashboardHelper.Companion.getWaterIntakeAllowed());
                    } else if (reward.getRedirectionKey().equalsIgnoreCase("meditation")) {
                        showPopUpZenZone(FeedbackActivityRewardList.this, Double.parseDouble(NewDashboardHelper.Companion.getCurrentValueZenZone()));
                    } else {
    ...
    public void checkPermission(String permission, int requestCode) {
        ...
        if (ContextCompat.checkSelfPermission(FeedbackActivityRewardList.this, permission) == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(FeedbackActivityRewardList.this, new String[]{permission}, requestCode);
        } else {
            openGalleryOnly();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == CAMERA_PERMISSION_CODE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(FeedbackActivityRewardList.this, "Camera Permission Denied", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        if (requestCode == 1) {
            try {
                ...
                if (fileUploadKey.equalsIgnoreCase("JournalUpload")) {
                    ...
                    try {
                        uploadFileWithContent("Feedback", titleContent, Integer.parseInt(quizreward.getTransId()));
                    } catch (Exception ex) {
                        ex.printStackTrace();
                    }
                }
...
//                Toast.makeText(context, context.getResources().getString(R.string.error_string), Toast.LENGTH_SHORT).show();
    ...
    private void showBonusRewardsPopup(String rewards, Context context) {
        ...
        binding.scratchView.setScratchListener(FeedbackActivityRewardList.this);
    ...
    private void showRewardsPopupDialogBox() {
        if (NewDashboardHelper.Companion.getPopUpShowModels().size() > 0) {
            ...
            switch (firstData.getKey()) {
                ...
                case "FeedbackPOPUP":
                    FeedbackPopupDialogBox instance = FeedbackPopupDialogBox.Companion.getInstance();
                    instance.showPopUpFeedback(FeedbackActivityRewardList.this, NewDashboardHelper.Companion.getFeedbackResponseData());
                    break;
                default:
