...
public class QuizActivityRewardList extends AppCompatActivity implements ScratchListener, onRewardClick, spinRewardCallBack, rewardDialogCloseListener {
...
//         rewardResponse = new Gson().fromJson(response, postLogRewardType);
        ...
        if (rewardResponse.getData().getActiveList() != null && !rewardResponse.getData().getActiveList().isEmpty()) {
            ...
            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(QuizActivityRewardList.this, LinearLayoutManager.HORIZONTAL, false);
            ...
            LinearLayoutManager absorbHealthTvLinearLayoutManager1 = new LinearLayoutManager(QuizActivityRewardList.this);
            ...
            IndicatorsAdapter absorbHealthTvIndicatorsAdapter = new IndicatorsAdapter(QuizActivityRewardList.this, indicatorSize, 0);
            ...
            binding.tvActiveVewAll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent in = new Intent(QuizActivityRewardList.this, QuizathonViewAllActivity.class);
            ...
            RewardInfoBottomSheet dialog = new RewardInfoBottomSheet(context, reward, type, new onRewardDialogClick() {
                ...
                public void onStartClick() {
                    ...
                    if (reward.getRedirectionKey().contains("feedback")) {
                        ...
                        instance.showPopUpFeedbackCallback(QuizActivityRewardList.this, feedbackResponseData, QuizActivityRewardList.this);
                    }
                }
                ...
                public void onCompleteClick() {
                    ...
                    if (reward.getRedirectionKey().contains("feedback")) {
                        ...
                        waterIntakeDialoge(QuizActivityRewardList.this, NewDashboardHelper.Companion.getWaterIntakeGoal(), NewDashboardHelper.Companion.getWaterIntake(), NewDashboardHelper.Companion.getWaterIntakeAllowed());
                    } else if (reward.getRedirectionKey().equalsIgnoreCase("meditation")) {
                        showPopUpZenZone(QuizActivityRewardList.this, Double.parseDouble(NewDashboardHelper.Companion.getCurrentValueZenZone()));
                    } else {
    ...
    public void checkPermission(String permission, int requestCode) {
        ...
        if (ContextCompat.checkSelfPermission(QuizActivityRewardList.this, permission) == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(QuizActivityRewardList.this, new String[]{permission}, requestCode);
        } else {
            openGalleryOnly();
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == CAMERA_PERMISSION_CODE) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(QuizActivityRewardList.this, "Camera Permission Denied", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        if (requestCode == 1) {
            try {
                ...
                if (fileUploadKey.equalsIgnoreCase("JournalUpload")) {
                    ...
                    try {
                        uploadFileWithContent("Quiz", titleContent, Integer.parseInt(quizreward.getTransId()));
                    } catch (Exception ex) {
                        ex.printStackTrace();
                    }
                }
...
//                Toast.makeText(context, context.getResources().getString(R.string.error_string), Toast.LENGTH_SHORT).show();
    ...
    private void showBonusRewardsPopup(String rewards, Context context) {
        ...
        binding.scratchView.setScratchListener(QuizActivityRewardList.this);
    ...
    private void showRewardsPopupDialogBox() {
        if (NewDashboardHelper.Companion.getPopUpShowModels().size() > 0) {
            ...
            switch (firstData.getKey()) {
                ...
                case "FeedbackPOPUP":
                    FeedbackPopupDialogBox instance = FeedbackPopupDialogBox.Companion.getInstance();
                    instance.showPopUpFeedback(QuizActivityRewardList.this, NewDashboardHelper.Companion.getFeedbackResponseData());
                    break;
                default:
