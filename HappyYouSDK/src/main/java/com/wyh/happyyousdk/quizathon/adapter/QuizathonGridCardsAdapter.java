...
public class QuizathonGridCardsAdapter extends RecyclerView.Adapter<QuizathonGridCardsAdapter.GridCardsViewHolder> {
    ...
    public QuizathonGridCardsAdapter(List<RewardItem> rewardItemList, String type, onRewardClick onRewardClick) {
