...
public class ActometerStackBarDiagnosticTagsAdapter extends RecyclerView.Adapter<ActometerStackBarDiagnosticTagsAdapter.MyViewHolder> {
    ...
    public ActometerStackBarDiagnosticTagsAdapter(Context context, List<String> tagNameList, int selectedItem, int communityId, String activityType, String periodType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.binding.tvArticleTag.setOnClickListener(view -> {
            ...
            if (context instanceof ActoMeterCommunityActivity) {
                ...
                ((ActoMeterCommunityActivity) context).fetchCommunityGraphDiagnosticsStack(periodType, tagName, communityId, DAILY, diagnosticType);
            }
