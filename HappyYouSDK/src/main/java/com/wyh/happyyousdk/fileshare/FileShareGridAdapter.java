...
public class FileShareGridAdapter extends BaseAdapter {
    ...
    public FileShareGridAdapter(Context context, List<FileShareResp.Data> policyDetailsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        AdapterFileShareListBinding binding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.adapter_file_share_list, parent, false);
        ...
        FileShareResp.Data data = fileShareResps.get(position);
            ...
            binding.llMain.setBackground(ContextCompat.getDrawable(context, res[pos]));
            if(pos < 2){
                pos++;
            }else{
                pos =0;
