...
import static com.wyh.happyyousdk.utils.Constants.SpinRewards;
...
public class WebActivity extends AppCompatActivity implements ScratchListener, rewardDialogCloseListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            if (comingFrom != null && comingFrom.equalsIgnoreCase("PolicyListActivity")) {
    ...
    public void cancelDialog() {
        try {
            if(spinRewardData != null) {
                NudgeDialogue.INSTANCE.spinnerCancelDialogWeb(context, spinRewardData.getRewardType(), this, new rewardDialogCloseListener() {
                    @Override
                    public void onDialogDismiss() {
                        finish();
                    }
                ...
                NudgeDialogue.INSTANCE.spinnerCancelDialogWeb(context, quizreward.getRewardType(), this, new rewardDialogCloseListener() {
                    @Override
                    public void onDialogDismiss() {
                        finish();
                    }
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
            ...
            if (url.contains("api.whatsapp.com")) {
                ...
                view.loadUrl(WebActivity.this.url);
                return true;
                ...
                try {
                    ...
                    if (intent.resolveActivity(getPackageManager()) != null) {
                        ...
                        if (url.contains("//profile/100063766281689") || url.contains("emohaeldercare")) {
                            Uri fallbackUrl = Uri.parse("https://www.facebook.com/emohaeldercare/");
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if (url.contains("medPay") || url.contains("healthassure") || url.contains("emoha")) {
                location_permission();
            }
            ...
            webView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
                    ...
                    if (consoleMessage.message().contains("rewards:")) {
                        ...
                        showRewardsPopupNew(rewardsText, WebActivity.this);*/
                    }
                    ...
                    if (consoleMessage.message().contains("exit button clicked")) {
                        if (spinRewardData == null && quizreward == null) {
                    ...
                    if (consoleMessage.message().contains("toast")) {
                        ...
                        if (toastMessage != null)
                            Toast.makeText(WebActivity.this, toastMessage, Toast.LENGTH_SHORT).show();
...
//                    callback.invoke(origin, true, false);
                    ///Below Code added for Location Permission
                    if (ActivityCompat.checkSelfPermission(WebActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) !=
    ...
    private void requestCallPermission() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CALL_PHONE)
            ...
            Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse(requestURL));
            startActivity(intent);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_LOCATION_PERMISSION) {
            Set<String> notGrantedPermissionSet = new HashSet<String>();
            for (int i = 0; i < grantResults.length; i++) {
                if (grantResults[i] == -1) {
                    notGrantedPermissionSet.add(permissions[i]);
                }
            }
            List permissionList = Arrays.asList(permissions);
            if (notGrantedPermissionSet.isEmpty() &&
    ...
    private void showWebinarPopup(String rewardText, String rewardType) {
        try {
            ...
            binding.scratchView.setScratchListener(WebActivity.this);
