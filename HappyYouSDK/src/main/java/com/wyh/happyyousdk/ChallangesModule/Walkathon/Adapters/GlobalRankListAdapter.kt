...
class GlobalRankListAdapter(val context: Context, var list : ArrayList<GlobalRanking>, val comingFrom : String) : RecyclerView.Adapter<GlobalRankListAdapter.ViewHolder>() {
