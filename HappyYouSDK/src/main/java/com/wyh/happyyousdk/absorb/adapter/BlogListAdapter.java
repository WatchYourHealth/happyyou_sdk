...
public class BlogListAdapter extends RecyclerView.Adapter<BlogListAdapter.MyViewHolder> {
    ...
    private final BlogListAdapter.OnItemClickListener listener;

    public BlogListAdapter(Context context, List<GetQuickReadResponse.Data.Blog> blogList, OnItemClickListener listener) {
        ...
        switch (position) {
            case 0:
                for (int i = 0; i < 2; i++) {
                    ...
                    if (i == 0) {
                        if (!blogList.isEmpty()) {
                            holder.binding.tvArticle1.setText(blogList.get(i).getArticleName());
                            Glide.with(context)
                                    .load(blogList.get(i).getImgPath())
...
//                .placeholder(circularProgressDrawable)
                            ...
                            holder.binding.cvArticle1.setOnClickListener(view -> {
                                ...
                                intent.putExtra("article_code", blogList.get(index).getArticleCode());
//                                intent.putExtra("title", blogList.get(index).getArticleName());
//                                intent.putExtra("description", blogList.get(index).getArticleName());
                                //intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                context.startActivity(intent);
                            });
                            if (blogList.get(i).getIsBookMarked() == 1) {
                            ...
                            holder.binding.ivBookmark1.setOnClickListener(view -> listener.onClick(blogList.get(index).getArticleCode(), blogList.get(index).getIsBookMarked() != 1));
                        }
                    } else if (i == 1) {
                        if (blogList.size() > 1) {
                            holder.binding.tvArticle2.setText(blogList.get(i).getArticleName());
                            Glide.with(context)
                                    .load(blogList.get(i).getImgPath())
                                    .error(R.drawable.dummy_image)
//                .placeholder(circularProgressDrawable)
                            ...
                            holder.binding.ivBookmark2.setOnClickListener(view -> listener.onClick(blogList.get(index).getArticleCode(), blogList.get(index).getIsBookMarked() != 1));
                        } else {
                    ...
                    } else if (blogList.size() < 3) {
                        holder.binding.rlArticle2.setVisibility(View.VISIBLE);
                    }


//                    if (i == position) {
//                        holder.binding.tvArticle1.setText(blogList.get(position).getArticleName());
//                    }
//                    Glide.with(context)
//                            .load(blogList.get(i).getImgPath())
//                            .error(R.drawable.dummy_image)
...
//                .placeholder(circularProgressDrawable)
    ...
    public int getItemCount() {
        if (blogList.size() > 6) {
            ...
            return (int) Math.ceil(Double.parseDouble(String.valueOf(blogList.size())) / 2.0);
        } else {
            return 1;
        }
    }
