...
class RespiratoryCheck : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(comingFrom.equals("metalFitness",true)){
            binding.respiratoryCheckBg.setImageResource(R.drawable.sonde_mental_fitness_img)
            ...
            binding.respiratoryCheckBg.setImageResource(R.drawable.sonde_respiratory_lungs_img)
        ...
        binding.DashboardHistoryImg.setOnClickListener {
            ...
            startActivity(Intent(this,SondeHistory::class.java)
        ...
        binding.respiratoryProceedBtn.setOnClickListener {
            ...
            startActivity(Intent(this,DirectionScreen::class.java).putExtra("comingFrom",comingFrom))
        }
