...
public class DareReferralFragment extends Fragment {

    ConnectionListLayoutBinding binding;
    Context context;

    ArrayList<ConnectionListModel> dareReferralList;


    public DareReferralFragment() {
    }

    public DareReferralFragment(Context context, ArrayList<ConnectionListModel> dareReferralList) {
        this.context = context;
        this.dareReferralList = dareReferralList;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        context = getActivity();
        if(dareReferralList.size() == 0){
            binding.noDataFoundTv.setVisibility(View.VISIBLE);
            binding.totalCountTv.setText("Your Referral tile is count "+ dareReferralList.size());
            ...
            binding.totalCountTv.setText("Your Referral tile count is "+ dareReferralList.size());
            ConnectionListAdapter connectionListAdapter = new ConnectionListAdapter(context,dareReferralList);
        ...
        binding.infoImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                customYesNoDialog.binding.popupHeading.setText("Dare Referral count");
                customYesNoDialog.binding.txtInfoPopUpDesc.setText("Your Dare referral Count is "+ ProfileActivity.dareReferralCount);
                customYesNoDialog.binding.btnCancel.setVisibility(View.GONE);
